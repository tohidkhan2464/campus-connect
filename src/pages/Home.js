      ...
      <div className="relative flex items-center justify-center max-w-[70vw] w-11/12 h-[calc(100%-1rem)]">
        <div className="z-10 w-11/12">
          ...
          <div className="flex flex-col my-96 mobileS:my-40 mobileM:my-40 items-center justify-center">
            {/* tagline */}
            <p className="text-4xl text-center font-semibold mobileS:text-sm mobileM:text-sm ">
              Campus Connect - Bridging Students and Professors to Foster a
              Vibrant and Collaborative{" "}
              <span className="  text-richblue-200 mobileS:text-sm mobileM:text-sm text-transparent bg-clip-text bg-gradient-to-t from-[#c471ed] to-[#f64f59]">
        ...
        <div className=" absolute top-40 z-0 bg-gradient-to-r from-primary-700 via-primary-500 to-cyan-300  h-[550px] w-[600px] mobileS:w-[200px] mobileM:w-[250px]  rounded-full blur-[90px] "></div>
        <div className=" absolute top-40 -left-32 mobileS:left-0 mobileM:left-0 z-0 bg-gradient-to-r from-primary-900 to-primary-500  h-[550px] w-[600px] mobileS:w-[200px] mobileM:w-[250px] rounded-full blur-[90px] "></div>
        <div className=" absolute top-40 -right-32 mobileS:right-0 mobileM:right-0 z-0 bg-gradient-to-r to-cyan-100 from-cyan-300  h-[550px] w-[600px] mobileS:w-[200px] mobileM:w-[250px] rounded-full blur-[90px] "></div>
      </div>
    </div>
  );
};
