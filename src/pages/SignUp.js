...
const SignUp = () => {
  ...
  return (
    <div className="bg-gradient-to-br from-blue to-red w-screen min-h-screen flex items-center justify-center">
      <div>
        <div className=" bg-white flex items-center justify-center mt-14 p-8 mobileS:mt-10 mobileM:mt-10 mobileM:py-2 mobileM:p-4 mobileM:max-w-[350px] mobileS:p-4 mobileS:py-2 rounded-lg w-[600px] mobileS:w-[300px]">
          <div className="flex flex-col items-center w-full">
            <div className="text-4xl my-1 font-semibold mobileS:text-xl mobileM:text-xl w-full text-center">
              SIGN UP
            </div>
            <form onSubmit={submitHandler} className="w-full">
              <div className="flex flex-col items-center my-1 mobileS:m-0 mobileM:m-0 mobileM:text-sm mobileS:text-sm group w-full">
              ...
              <div className="flex flex-row mobileS:flex-col mobileM:flex-col mobileM:gap-0 mobileM:text-sm gap-4 mobileS:gap-0  mobileS:text-sm">
                {/* First Name */}
              ...
              <div className="flex flex-row mobileS:flex-col gap-4 mobileM:flex-col mobileM:gap-0 mobileM:text-sm mobileS:gap-0  mobileS:text-sm">
                {/* User-Name */}
                <div className="flex flex-col items-center my-2 mobileS:my-1 mobileM:my-1 group w-full">
              ...
              <button type="submit" className="submit-button-style mobileS:my-2 mobileM:my-2 mobileM:text-sm  mobileS:text-sm">
                SUBMIT
              </button>
            </form>
