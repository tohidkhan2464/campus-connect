  ...
  return (
    <div>
      <div className="w-9/12 mx-auto">
        <div className="flex flex-col justify-between mt-4  bg-white p-6 rounded-lg border-[3px] border-secondary-600 z-0">
          <div className="flex flex-row gap-x-6 w-full items-center ">
            <div className="p-1 border-[2px] border-secondary-500 rounded-full">
              <img
                src={previewSource || user?.profileImage || `${user?.profileImage}`}
