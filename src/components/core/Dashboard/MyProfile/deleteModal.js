...
const DeleteModal = ({ token, user, deleteModal, setDeleteModal }) => {
  ...
  return (
    <div className="absolute h-screen w-screen mt-0 -top-[5.8rem] mobileS:top-0 tablet:left-0 laptop:-left-11 display4K:-left-16 display4K:-top-[7.5rem] mobileL:left-0 mobileS:left-0 mobileM:top-0 mobileM:left-0 -left-16 z-[1000]">
