...
const ViewImageModal = ({ image, setViewImage }) => {
  return (
    <div>
      <div className="absolute h-screen w-screen mt-0 mobileS:-left-0 display4K:-left-16 display4K:-top-[7.5rem] tablet:left-0 mobileM:left-0 -top-[5.75rem] -left-20 z-[1000]">
        <div
