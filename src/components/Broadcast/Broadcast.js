          ...
          <div className="w-full">
            <div className="w-full">
              ...
              <input
                ...
                className="outline-none mt-2 border-[2px] border-slate-300 py-1 px-2 rounded-md  w-[100%] outline-b"
              />
            </div>
            <div className="w-full">
              <label
          ...
          <div className="flex gap-x-10 w-full justify-between">
            <div className="w-full">
              ...
              <select
                ...
                name="broadcastBy"
                id="broadcastBy"
                className="outline-none mt-2 border-[2px] border-slate-300 py-1 px-2 rounded-md  w-[100%] outline-b text-left p-2 cursor-pointer"
