exports.emailVerification = (otp) => {
  return `
    ...
    <body>
        <div class="container">
            <img class="logo" src="https://github.com/tohidkhan2464/tohidkhan2464/blob/main/images/logo.svg" alt="StudyNotion Logo" >
            <div class="message">OTP verification Email</div>
            <div class="body">
                <p>Dear User,</p>
                <p>
                    Thank you for registering with Campus Connect. To complete your registration, please use the following
